...
class Rate extends DBController
{
    ...
    function getAllPost()
    {
        $query = "SELECT tutorial.*, COUNT(tbl_member_rating.rating) as rating_count, SUM(tbl_member_rating.rating) as rating_total FROM tutorial LEFT JOIN tbl_member_rating ON tutorial.id = tbl_member_rating.tutorial_id GROUP BY tbl_member_rating.tutorial_id";
    ...
    {
        $query = "SELECT tutorial.*, COUNT(tbl_member_rating.rating) as rating_count, SUM(tbl_member_rating.rating) as rating_total FROM tutorial LEFT JOIN tbl_member_rating ON tutorial.id = tbl_member_rating.tutorial_id WHERE tbl_member_rating.tutorial_id = ? GROUP BY tbl_member_rating.tutorial_id";
