...
" src="'.$userData['picture'].'"/>';
        ...
        $output .= '<div> <a href="http://localhost/VMS/PHP02/index.php" target="_blank"><img id="continue" src="https://pngimage.net/wp-content/uploads/2018/05/continue-button-png-3.png"</a><a href="'.$logoutURL.'"><img id="logout" src="http://www.velsarena.com/wp-content/uploads/2013/10/logout.png"></a></div>';
        $output .= '</div>';
		$output .= '</div>';
...
<div class="container" >
    <div class="fb-box" >
        ...
        <div align="center" style="width:400px; height:350px ;background:#b2c8ea1f ; border-radius:20px ;    margin-left: 400px;
"  >
        <?php echo $output; ?>
        </div>
    </div>
